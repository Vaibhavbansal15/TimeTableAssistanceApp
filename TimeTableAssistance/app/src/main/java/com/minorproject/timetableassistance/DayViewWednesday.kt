...
class DayViewWednesday : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_day_view_wednesday)
        ...
        val responseLiveData: LiveData<ArrayList<TimeTableResponseDataClass>> =
            liveData {
                var requestBody = TimeTableRequest("WED", "B10", "Sem5_TT.json")
        ...
        right_arrow.setOnClickListener{
            startActivity(Intent(this, DayViewThursday::class.java))
            finish()
        }
